...
export default function AddFriends() {
    ...
    const handleClick = (user) => {
        ...
        setUsersId([...usersId, {user: user.id}])
        // userDispatch({
    ...
    // Sorting the users in a search box
    useEffect(() => {
        if(users){
    ...
    // menage of the users selected by the user
    useEffect(()=>{
        userDispatch({
            type: USER_ACTION.ADD_FRIENDS_TO_CHALLENGE,
            friendsToChallenge: usersId,
        })
