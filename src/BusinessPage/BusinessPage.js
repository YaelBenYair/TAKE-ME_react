...
import BusinessAccessibilities from "../BusinessAccessibilities/BusinessAccessibilities";
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Box
                className="business-profile-bg-image"
                sx={{
              ...
              >
                <img id="prf-bg-img" src={business.cover} alt="" srcSet="" />
              </Box>
              <Box
                className="edit-icon"
                sx={{
              ...
              >
                ...
                >
                  ...
                  <Checkbox
                    ...
                    checkedIcon={
                      <FavoriteRoundedIcon color="primary" sx={iconStyle} />
                    }
                  />
                </Box>
              </Box>
                ...
                >
                  {business.accessibilities && (
                    <BusinessAccessibilities
                      accessibility={business.accessibilities}
                    />
                  )}
                </Box>
